...
/// 확인된 문제: (1) vibrationLowpassCutoffHz 등 축 무관 필터 값은 이동평균
/// 방식으로 설계했던 시기의 잔재이며 현재 설계와 맞지 않는다. (2) 판정 임계값
/// xyThresholdMg / zThresholdMg / noiseThresholdDba 가 참조 장비 출력물의
/// 기준과 다르다. 분석 계층 구현 시 참조 출력물과 대조해 다시 정한다.
///
